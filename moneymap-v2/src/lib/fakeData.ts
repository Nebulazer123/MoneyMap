...
export type OwnershipMap = Record<string, boolean>;
export type AccountModeMap = Record<string, OwnershipMode>;
...
export const transactions: Transaction[] = [
    // Income
    { id: "t1", date: "2025-11-01", description: "Paycheck - Direct Deposit", amount: 5200, category: "Income", kind: "income", source: "Employer Payroll", target: "Primary checking", accountId: "checking" },
    { id: "t2", date: "2025-11-15", description: "Paycheck - Direct Deposit", amount: 5200, category: "Income", kind: "income", source: "Employer Payroll", target: "Primary checking", accountId: "checking" },

    // Housing
    { id: "t3", date: "2025-11-01", description: "Rent or mortgage", amount: -1850, category: "Rent", kind: "expense", source: "Primary checking", target: "Landlord ACH", accountId: "checking" },
    { id: "t4", date: "2025-11-05", description: "Internet service", amount: -79.99, category: "Utilities", kind: "expense", source: "Primary checking", target: "ISP", accountId: "checking" },
    { id: "t5", date: "2025-11-10", description: "Electric utility", amount: -124.50, category: "Utilities", kind: "expense", source: "Primary checking", target: "Power Co", accountId: "checking" },
    { id: "t6", date: "2025-11-12", description: "Water utility", amount: -45.00, category: "Utilities", kind: "expense", source: "Primary checking", target: "Water Dept", accountId: "checking" },

    // Groceries
    { id: "t7", date: "2025-11-03", description: "Groceries - Weekly shop", amount: -152.34, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t8", date: "2025-11-06", description: "Groceries - Quick trip", amount: -42.15, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t9", date: "2025-11-10", description: "Groceries - Weekly shop", amount: -168.90, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t10", date: "2025-11-14", description: "Groceries - Quick trip", amount: -38.22, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t11", date: "2025-11-17", description: "Groceries - Weekly shop", amount: -145.67, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t12", date: "2025-11-21", description: "Groceries - Quick trip", amount: -51.08, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },
    { id: "t13", date: "2025-11-24", description: "Groceries - Weekly shop", amount: -178.45, category: "Groceries", kind: "expense", source: "Credit card", target: "Grocery Store", accountId: "checking" },

    // Dining
    { id: "t14", date: "2025-11-02", description: "Coffee shop", amount: -8.50, category: "Dining", kind: "expense", source: "Credit card", target: "Coffee Shop", accountId: "checking" },
    { id: "t15", date: "2025-11-04", description: "Lunch - Fast food", amount: -12.75, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t16", date: "2025-11-07", description: "Dinner - Casual dining", amount: -54.30, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t17", date: "2025-11-09", description: "Coffee shop", amount: -6.25, category: "Dining", kind: "expense", source: "Credit card", target: "Coffee Shop", accountId: "checking" },
    { id: "t18", date: "2025-11-11", description: "Lunch - Quick bite", amount: -15.40, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t19", date: "2025-11-13", description: "Pizza delivery", amount: -32.50, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t20", date: "2025-11-16", description: "Coffee shop", amount: -7.80, category: "Dining", kind: "expense", source: "Credit card", target: "Coffee Shop", accountId: "checking" },
    { id: "t21", date: "2025-11-18", description: "Lunch - Fast food", amount: -11.20, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t22", date: "2025-11-20", description: "Dinner - Casual dining", amount: -68.90, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t23", date: "2025-11-22", description: "Brunch", amount: -42.15, category: "Dining", kind: "expense", source: "Credit card", target: "Restaurant", accountId: "checking" },
    { id: "t24", date: "2025-11-25", description: "Coffee shop", amount: -9.10, category: "Dining", kind: "expense", source: "Credit card", target: "Coffee Shop", accountId: "checking" },

    // Transport
    { id: "t25", date: "2025-11-02", description: "Gas station", amount: -52.30, category: "Transport", kind: "expense", source: "Credit card", target: "Gas Station", accountId: "checking" },
    { id: "t26", date: "2025-11-05", description: "Uber ride", amount: -18.45, category: "Transport", kind: "expense", source: "Credit card", target: "Rideshare", accountId: "checking" },
    { id: "t27", date: "2025-11-09", description: "Gas station", amount: -48.90, category: "Transport", kind: "expense", source: "Credit card", target: "Gas Station", accountId: "checking" },
    { id: "t28", date: "2025-11-14", description: "Lyft ride", amount: -22.10, category: "Transport", kind: "expense", source: "Credit card", target: "Rideshare", accountId: "checking" },
    { id: "t29", date: "2025-11-18", description: "Gas station", amount: -55.20, category: "Transport", kind: "expense", source: "Credit card", target: "Gas Station", accountId: "checking" },
    { id: "t30", date: "2025-11-23", description: "Transit pass", amount: -75.00, category: "Transport", kind: "expense", source: "Credit card", target: "Transit", accountId: "checking" },
    { id: "t31", date: "2025-11-26", description: "Gas station", amount: -50.75, category: "Transport", kind: "expense", source: "Credit card", target: "Gas Station", accountId: "checking" },

    // Subscriptions
    { id: "t32", date: "2025-11-01", description: "Streaming service", amount: -15.99, category: "Subscriptions", kind: "subscription", source: "Credit card", target: "Netflix", accountId: "checking" },
    { id: "t33", date: "2025-11-03", description: "Music subscription", amount: -10.99, category: "Subscriptions", kind: "subscription", source: "Credit card", target: "Spotify", accountId: "checking" },
    { id: "t34", date: "2025-11-05", description: "Cloud storage", amount: -2.99, category: "Subscriptions", kind: "subscription", source: "Credit card", target: "iCloud", accountId: "checking" },
    { id: "t35", date: "2025-11-08", description: "Gym membership", amount: -45.00, category: "Subscriptions", kind: "subscription", source: "Credit card", target: "Gym", accountId: "checking" },
    { id: "t36", date: "2025-11-10", description: "Software subscription", amount: -9.99, category: "Subscriptions", kind: "subscription", source: "Credit card", target: "Adobe", accountId: "checking" },

    // Bills & Services
    { id: "t37", date: "2025-11-05", description: "Mobile phone bill", amount: -85.00, category: "Bills & services", kind: "expense", source: "Primary checking", target: "Carrier", accountId: "checking" },
    { id: "t38", date: "2025-11-15", description: "Auto insurance", amount: -156.50, category: "Insurance", kind: "expense", source: "Primary checking", target: "Insurance Co", accountId: "checking" },
    { id: "t39", date: "2025-11-20", description: "Health insurance", amount: -245.00, category: "Insurance", kind: "expense", source: "Primary checking", target: "Health Ins", accountId: "checking" },
    { id: "t40", date: "2025-11-10", description: "Student loan payment", amount: -350.00, category: "Loans", kind: "expense", source: "Primary checking", target: "Loan Servicer", accountId: "checking" },
    { id: "t41", date: "2025-11-08", description: "Car payment", amount: -425.00, category: "Auto", kind: "expense", source: "Primary checking", target: "Auto Lender", accountId: "checking" },

    // Shopping & Other
    { id: "t42", date: "2025-11-04", description: "Amazon purchase", amount: -34.99, category: "Other", kind: "expense", source: "Credit card", target: "Amazon", accountId: "checking" },
    { id: "t43", date: "2025-11-08", description: "Pharmacy prescription", amount: -25.50, category: "Health", kind: "expense", source: "Credit card", target: "CVS", accountId: "checking" },
    { id: "t44", date: "2025-11-11", description: "Target shopping", amount: -87.32, category: "Other", kind: "expense", source: "Credit card", target: "Target", accountId: "checking" },
    { id: "t45", date: "2025-11-14", description: "Amazon purchase", amount: -52.18, category: "Other", kind: "expense", source: "Credit card", target: "Amazon", accountId: "checking" },
    { id: "t46", date: "2025-11-17", description: "Home Depot", amount: -124.75, category: "Other", kind: "expense", source: "Credit card", target: "Home Depot", accountId: "checking" },
    { id: "t47", date: "2025-11-19", description: "Best Buy electronics", amount: -215.99, category: "Other", kind: "expense", source: "Credit card", target: "Best Buy", accountId: "checking" },
    { id: "t48", date: "2025-11-22", description: "Walmart", amount: -64.23, category: "Other", kind: "expense", source: "Credit card", target: "Walmart", accountId: "checking" },
    { id: "t49", date: "2025-11-24", description: "Amazon purchase", amount: -41.50, category: "Other", kind: "expense", source: "Credit card", target: "Amazon", accountId: "checking" },

    // Fees
    { id: "t50", date: "2025-11-12", description: "ATM fee", amount: -3.50, category: "Fees", kind: "fee", source: "Primary checking", target: "ATM", accountId: "checking" },
    { id: "t51", date: "2025-11-18", description: "Late payment fee", amount: -25.00, category: "Fees", kind: "fee", source: "Credit card", target: "Bank", accountId: "checking" },

    // Internal Transfers
    { id: "t52", date: "2025-11-05", description: "Transfer to wallet", amount: -200.00, category: "Transfer", kind: "transferInternal", source: "Primary checking", target: "Cash App", accountId: "checking", sourceKey: "navy_checking", targetKey: "cash_app" },
    { id: "t53", date: "2025-11-20", description: "Transfer from wallet", amount: 150.00, category: "Transfer", kind: "transferInternal", source: "Cash App", target: "Primary checking", accountId: "checking", sourceKey: "cash_app", targetKey: "navy_checking" },
];
...
export function generateSampleStatement(
    ...
    // Default to 6 months back if no range provided
    const today = new Date();
    const defaultEndMonth = today.getMonth();
    const defaultEndYear = today.getFullYear();

    // Calculate start date (18 months ago)
    const d = new Date(today);
    d.setMonth(d.getMonth() - 17); // 17 months back + current month = 18 months
    const defaultStartMonth = d.getMonth();
    const defaultStartYear = d.getFullYear();

    const startMonth = monthFromOverride ?? defaultStartMonth;
    const startYear = yearFromOverride ?? defaultStartYear;
    const endMonth = monthToOverride ?? defaultEndMonth;
    const endYear = yearToOverride ?? defaultEndYear;
    ...
    const generated = monthsInRange.flatMap(({ month, year }, monthIndex) =>
        transactions.map((t, index) => {
            ...
            // Ensure we don't generate day 0 if today is the 1st
